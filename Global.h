...
#define SERIAL_ON MONITOR_BRIGHTNESS_PER_CYCLE | MONITOR_TIMINGS | MONITOR_RAW_INPUT | MONITOR_NORMALISED_INPUT | MONITOR_BUTTON_OUTPUT | MONITOR_BUTTON_PRESS | MONITOR_EVENTS | MONITOR_STATE | MONITOR_BRIGHTNESS | MONITOR_PWM_LIST| MONITOR_REGISTER_SIGNAL | MONITOR_LIFE | MONITOR_MAKE_TREE
