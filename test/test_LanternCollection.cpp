...
void test_beacons_1( uint8_t verbose=0 ) {
    std::cout << "Test beacons: 1. Turning off at a distance.";
    Instruction sequence[] = {
          Instruction( 0x00    , START_TEST )
        , Instruction( 0x00    , ASSERT_STATE_EQ, IDLE_ID, 4 )

        , Instruction( 0x04    , SET_SENSOR_VALUE, 1, 4 )
        , Instruction( 0x14    , SET_SENSOR_VALUE, 0, 4 )

        , Instruction( 0x8f    , SET_SENSOR_VALUE, 1, 0xf )
        , Instruction( 0x9f    , SET_SENSOR_VALUE, 0, 0xf )

        , Instruction( 0x10f   , SET_SENSOR_VALUE, 1, 0xf )
        , Instruction( 0x18f   , SET_SENSOR_VALUE, 0, 0xf )

        , Instruction( 0x500   , END_TEST )
    };
    runTestSequence( sequence, verbose );
}


void test_beacons_2( uint8_t verbose=0 ) {
    std::cout << "Test beacons: 2. Turning on at a distance.";
    Instruction sequence[] = {
          Instruction( 0x00    , START_TEST )
        , Instruction( 0x00    , ASSERT_STATE_EQ, IDLE_ID, 4 )
        ...
        , Instruction( 0x28f   , SET_SENSOR_VALUE, 1, 0xf )
        , Instruction( 0x29f   , SET_SENSOR_VALUE, 0, 0xf )

        , Instruction( 0x2a4   , SET_SENSOR_VALUE, 1, 0x4 )
        , Instruction( 0x2b4   , SET_SENSOR_VALUE, 0, 0x4 )

        , Instruction( 0x30f   , SET_SENSOR_VALUE, 1, 0xf )
        , Instruction( 0x38f   , SET_SENSOR_VALUE, 0, 0xf )
